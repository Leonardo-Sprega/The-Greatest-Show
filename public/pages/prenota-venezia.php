...
<?php
    ...
    if(isset($_POST['biglietti-button'])){
        ...
        if($vip > mostra_posti('venezia','vip')){
            $errMsg = "Numero dei biglietti richiesti non disponibile";
            goto E;
        }
        if($primo > mostra_posti('venezia','primo')){
            $errMsg = "Numero dei biglietti richiesti non disponibile";
            goto E;
        }
        if($secondo > mostra_posti('venezia','secondo')){
            $errMsg = "Numero dei biglietti richiesti non disponibile";
            goto E;
        }
        if($terzo > mostra_posti('venezia','terzo')){
            $errMsg = "Numero dei biglietti richiesti non disponibile";
            goto E;
        }
        ...
        $query = "  INSERT INTO profilo(email,citta ,vip, primo , secondo ,terzo)
                    VALUES ('$email_utente', 'Venezia' , $vip , $primo , $secondo , $terzo )";
...
<div class="biglietti-form" >
    ...
    <form method="post" >
        ...
        <label class="form-label testo-titolo">VENEZIA </label>
        <br>
        ...
        <div class="mb-3">
            ...
            <div class="form-outline disponibilita">
                ...
                <div class="posti"><?php echo('Posti disponibili: ' . mostra_posti('venezia', 'vip')); ?> </div>
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="form-outline disponibilita">
                ...
                <div class="posti"><?php echo('Posti disponibili: ' . mostra_posti('venezia' , 'primo')); ?> </div>
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="form-outline disponibilita">
                ...
                <div class="posti"><?php echo('Posti disponibili: ' . mostra_posti('venezia' , 'secondo')); ?> </div>
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="form-outline disponibilita">
                ...
                <div class="posti"><?php echo('Posti disponibili: ' . mostra_posti('venezia' , 'terzo')); ?> </div>
            </div>
        </div>
