...
<?php
    ...
    if(isset($_POST['biglietti-button'])){
        ...
        if($vip > mostra_posti('torino','vip')){
            $errMsg = "Numero dei biglietti richiesti non disponibile";
            goto E;
        }
        if($primo > mostra_posti('torino','primo')){
            $errMsg = "Numero dei biglietti richiesti non disponibile";
            goto E;
        }
        if($secondo > mostra_posti('torino','secondo')){
            $errMsg = "Numero dei biglietti richiesti non disponibile";
            goto E;
        }
        if($terzo > mostra_posti('torino','terzo')){
            $errMsg = "Numero dei biglietti richiesti non disponibile";
            goto E;
        }
        ...
        $query = "  INSERT INTO profilo(email,citta ,vip, primo , secondo ,terzo)
                    VALUES ('$email_utente', 'Torino' , $vip , $primo , $secondo , $terzo )";
...
<div class="biglietti-form" >
    ...
    <form method="post" >
        ...
        <label class="form-label testo-titolo">TORINO </label>
        <br>
        ...
        <div class="mb-3">
            ...
            <div class="form-outline disponibilita">
                ...
                <div class="posti"><?php echo('Posti disponibili: ' . mostra_posti('torino', 'vip')); ?> </div>
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="form-outline disponibilita">
                ...
                <div class="posti"><?php echo('Posti disponibili: ' . mostra_posti('torino' , 'primo')); ?> </div>
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="form-outline disponibilita">
                ...
                <div class="posti"><?php echo('Posti disponibili: ' . mostra_posti('torino' , 'secondo')); ?> </div>
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="form-outline disponibilita">
                ...
                <div class="posti"><?php echo('Posti disponibili: ' . mostra_posti('torino' , 'terzo')); ?> </div>
            </div>
        </div>
