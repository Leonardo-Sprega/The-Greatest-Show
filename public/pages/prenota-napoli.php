...
<?php
    ...
    if(isset($_POST['biglietti-button'])){
        ...
        if($vip > mostra_posti('napoli','vip')){
            $errMsg = "Numero dei biglietti richiesti non disponibile";
            goto E;
        }
        if($primo > mostra_posti('napoli','primo')){
            $errMsg = "Numero dei biglietti richiesti non disponibile";
            goto E;
        }
        if($secondo > mostra_posti('napoli','secondo')){
            $errMsg = "Numero dei biglietti richiesti non disponibile";
            goto E;
        }
        if($terzo > mostra_posti('napoli','terzo')){
            $errMsg = "Numero dei biglietti richiesti non disponibile";
            goto E;
        }
        ...
        $query = "  INSERT INTO profilo(email,citta ,vip, primo , secondo ,terzo)
                    VALUES ('$email_utente', 'Napoli' , $vip , $primo , $secondo , $terzo )";
...
<div class="biglietti-form" >
    ...
    <form method="post" >
        ...
        <label class="form-label testo-titolo">NAPOLI </label>
        <br>
        ...
        <div class="mb-3">
            ...
            <div class="form-outline disponibilita">
                ...
                <div class="posti"><?php echo('Posti disponibili: ' . mostra_posti('napoli', 'vip')); ?> </div>
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="form-outline disponibilita">
                ...
                <div class="posti"><?php echo('Posti disponibili: ' . mostra_posti('napoli' , 'primo')); ?> </div>
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="form-outline disponibilita">
                ...
                <div class="posti"><?php echo('Posti disponibili: ' . mostra_posti('napoli' , 'secondo')); ?> </div>
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="form-outline disponibilita">
                ...
                <div class="posti"><?php echo('Posti disponibili: ' . mostra_posti('napoli' , 'terzo')); ?> </div>
            </div>
        </div>
