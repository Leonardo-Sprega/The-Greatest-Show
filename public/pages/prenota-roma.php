...
<?php
    ...
    if(isset($_POST['biglietti-button'])){
        ...
        if($vip > mostra_posti('roma','vip')){
            $errMsg = "Numero dei biglietti richiesti non disponibile";
            goto E;
        }
        if($primo > mostra_posti('roma','primo')){
            $errMsg = "Numero dei biglietti richiesti non disponibile";
            goto E;
        }
        if($secondo > mostra_posti('roma','secondo')){
            $errMsg = "Numero dei biglietti richiesti non disponibile";
            goto E;
        }
        if($terzo > mostra_posti('roma','terzo')){
            $errMsg = "Numero dei biglietti richiesti non disponibile";
            goto E;
        }
        ...
        $query = "  INSERT INTO profilo(email,citta ,vip, primo , secondo ,terzo)
                    VALUES ('$email_utente', 'Roma' , $vip , $primo , $secondo , $terzo )";
...
<div class="biglietti-form" >
    ...
    <form method="post" >
        ...
        <label class="form-label testo-titolo">ROMA </label>
        <br>
        ...
        <div class="mb-3">
            ...
            <div class="form-outline disponibilita">
                ...
                <div class="posti"><?php echo('Posti disponibili: ' . mostra_posti('roma', 'vip')); ?> </div>
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="form-outline disponibilita">
                ...
                <div class="posti"><?php echo('Posti disponibili: ' . mostra_posti('roma' , 'primo')); ?> </div>
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="form-outline disponibilita">
                ...
                <div class="posti"><?php echo('Posti disponibili: ' . mostra_posti('roma' , 'secondo')); ?> </div>
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="form-outline disponibilita">
                ...
                <div class="posti"><?php echo('Posti disponibili: ' . mostra_posti('roma' , 'terzo')); ?> </div>
            </div>
        </div>
