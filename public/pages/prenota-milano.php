...
<?php
    ...
    if(isset($_POST['biglietti-button'])){
        ...
        if($vip > mostra_posti('milano','vip')){
            $errMsg = "Numero dei biglietti richiesti non disponibile";
            goto E;
        }
        if($primo > mostra_posti('milano','primo')){
            $errMsg = "Numero dei biglietti richiesti non disponibile";
            goto E;
        }
        if($secondo > mostra_posti('milano','secondo')){
            $errMsg = "Numero dei biglietti richiesti non disponibile";
            goto E;
        }
        if($terzo > mostra_posti('milano','terzo')){
            $errMsg = "Numero dei biglietti richiesti non disponibile";
            goto E;
        }
        ...
        $query = "  INSERT INTO profilo(email,citta ,vip, primo , secondo ,terzo)
                    VALUES ('$email_utente', 'Milano' , $vip , $primo , $secondo , $terzo )";
...
<div class="biglietti-form" >
    ...
    <form method="post" >
        ...
        <label class="form-label testo-titolo">MILANO </label>
        <br>
        ...
        <div class="mb-3">
            ...
            <div class="form-outline disponibilita">
                ...
                <div class="posti"><?php echo('Posti disponibili: ' . mostra_posti('milano', 'vip')); ?> </div>
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="form-outline disponibilita">
                ...
                <div class="posti"><?php echo('Posti disponibili: ' . mostra_posti('milano' , 'primo')); ?> </div>
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="form-outline disponibilita">
                ...
                <div class="posti"><?php echo('Posti disponibili: ' . mostra_posti('milano' , 'secondo')); ?> </div>
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="form-outline disponibilita">
                ...
                <div class="posti"><?php echo('Posti disponibili: ' . mostra_posti('milano' , 'terzo')); ?> </div>
            </div>
        </div>
